...
channels = 3  # Assuming color images, adjust as needed
...
for filename in os.listdir(train_directory):
    if filename.endswith('.jpg') or filename.endswith('.png'):
        ...
        train_labels.append(1)  # Assuming all are of the same class, adjust as needed
...
for filename in os.listdir(valid_directory):
    if filename.endswith('.jpg') or filename.endswith('.png'):
        ...
        valid_labels.append(1)  # Assuming all are of the same class, adjust as needed
...
for filename in os.listdir(test_directory):
    if filename.endswith('.jpg') or filename.endswith('.png'):
        ...
        test_labels.append(1)  # Assuming all are of the same class, adjust as needed
...
# Build the MLP model
model = Sequential([
    Flatten(input_shape=(image_width, image_height, channels)),  # input layer
